...
//contract deployed at 0xB1ee0c20301F72847cCCfAa60b4bB76fC546372B
...
contract CitizenERC20 {
  ...
  constructor(
    ...
    _name = name;//CITIZEN
    _symbol = symbol;//CTZ
    _decimals = decimals;//18 (we divide the token amount by 10^18 to get its user representation).
    _cap = cap;// 1million full CTZ = 1000000000000000000000000000
    _totalSupply = amount2Owner;// 100% of cap : 1million full CTZ = 1000000000000000000000000000
  ...
  modifier onlyOwner() {
    require(msg.sender == _ownerAddress, 'ERC20: Only admins can perform this action');
    _;
  }
